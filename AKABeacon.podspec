Pod::Spec.new do |spec|
    ...
    spec.source_files  = 'AKABeacon/AKABeacon/Classes/*.{h,m}', 'AKABeacon/AKABeacon/Classes/AKACommons/*.{h,m}', 'AKABeacon/AKABeacon/AKABeacon.h'
    spec.private_header_files = 'AKABeacon/AKABeacon/Classes/*_Internal.h', 'AKABeacon/AKABeacon/Classes/AKACommons/*_Internal.h', 'AKABeacon/AKABeacon/AKABeacon.h'
