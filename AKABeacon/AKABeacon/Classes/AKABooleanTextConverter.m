                    ...
                    error:(NSError *__autoreleasing *)error
{
    ...
    if (result)
    {
        ...
        else
        {
            ...
            if (error != nil)
            {
                *error = [AKABeaconErrors conversionErrorInvalidModelValue:booleanValue
        ...
        else
        {
            ...
            if (error != nil)
            {
                *error = [AKABeaconErrors conversionErrorInvalidViewValue:viewValue
                        notAValidNumberParseError:[NSString stringWithFormat:@"Not one of %@, %@ or %@",
                                                                             self.textForYes,
                                                                             self.textForNo,
                                                                             self.textForUndefined]];
            }
        }
    }
