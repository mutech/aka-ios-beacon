                    ...
                    error:(NSError *__autoreleasing *)error
{
    ...
    if (modelValue != nil)
    {
        ...
        else
        {
            ...
            if (error)
            {
                *error = [AKABeaconErrors conversionErrorInvalidModelValue:modelValue
                        type:[modelValue class]
                   ...
                   error:(NSError *__autoreleasing *)error
{
    ...
    if (viewValue != nil)
    {
        if ([viewValue isKindOfClass:[NSString class]])
        {
            ...
            if (!result && error != nil)
            {
                *error = [AKABeaconErrors conversionErrorInvalidViewValue:text notAValidNumberParseError:description];
            }
        }
        else
        {
            ...
            if (error)
            {
                *error = [AKABeaconErrors conversionErrorInvalidViewValue:viewValue
