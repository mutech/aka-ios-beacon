//
//  UIView+AKABindingTargetContainer.h
//  AKABeacon
//
...
@interface UIView(AKABindingTargetContainer) <AKABindingTargetContainerProtocol>
...
/**
 ...
 The default implementation enumerates all subviews of this view.
