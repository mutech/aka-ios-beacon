...
LICENSE
    ...
    spec.source        = { :git => 'https://sources.aka-labs.com/scm/git/ios.aka.commons', :tag => 'v0.0.9-b007' }

    spec.source_files  = 'AKAControls/AKAControls/Classes/*.{h,m}'
    #spec.private_header_files = 'AKAControls/AKAControls/**/*_Internal.h', 'AKAControls/AKAControls/AKAControls.h'

    spec.platform      = :ios, "8.0"
    spec.ios.deployment_target = "8.0"

    spec.dependency    'AKACommons', '~> 0.0.9'
