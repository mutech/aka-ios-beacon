 ...
 * recognizable as control view. AKATextLabel supports read-only data binding.
 */
 ...
 * not change the model value as a result of user interactions. Setting this property to
